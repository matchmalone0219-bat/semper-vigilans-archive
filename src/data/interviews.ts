...
export const INTERVIEWS: InterviewQuote[] = [
  {
    ...
    note:
      "2026 年 9 月多伦多国际电影节（TIFF）期间接受 Collider 专访。被问及塞巴斯蒂安·斯坦此前盛赞续集的发言时，帕丁森用「real left turn」形容续集相对于前作的风格转向，同时表示仍保留了第一部的一些感觉基调。《TheWrap》与《Variety》等媒体随后跟进报道。",
  },
  {
  ...
  },
  {
    ...
    note:
      "2026 年 9 月 11 日《Variety》专访。斯坦以《教父2》作现场感受的夸张类比；他的具体角色仍未公开。",
  },
  {
  ...
  },
  {
    ...
    note:
      "TIFF 红毯受访时，斯坦表示拍摄还会持续“很长时间”，并称“这个冬天会很漫长”。",
  },
];
