...
export const SCREEN_TEST_DUEL: ScreenTestDuel = {
  ...
  summary:
    "在敲定主演之前，罗伯特·帕丁森与尼古拉斯·霍尔特进入最终竞争并接受镜头测试。帕丁森后来公开回忆，自己的试镜使用了方·基默时期的旧蝙蝠战衣；现有公开资料没有明确证明霍尔特使用同一套战衣，也不足以确认两人的测试规格完全一致。",
  candidates: [
    {
  ...
  details: [
    ...
    "公开报道确认帕丁森与霍尔特进入最终竞争并接受镜头测试，但现有可靠资料没有证明两人的战衣型号、拍摄介质与测试流程完全一致。",
