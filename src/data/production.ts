...
export const PRODUCTION_PHASES: ProductionPhase[] = [
  ...
  },
  {
    ...
    bulletPoints: [
      "大本向友人坦言：“给别人看剧本时，大家说写得很好，但如果你再经历一次这样的重压，可能会把自己逼到酗酒复发的崩溃边缘。”",
  ...
  },
  {
    ...
    period: "2019",
    tag: "重构与角逐",
    title: "脱离 DCEU 独立立项，帕丁森与霍尔特的 35mm 终极试镜",
    summary:
    ...
    bulletPoints: [
      ...
      "2019 年 5 月中旬，遴选缩窄至罗伯特·帕丁森与尼古拉斯·霍尔特（Nicholas Hoult）两位英国男演员，双雄飞赴加州伯班克制片厂进行高压决选。",
      "试镜细节：两人穿上方·基默在《永远的蝙蝠侠》（1995）中的经典战衣进行 35mm 胶片全装摄影测试，评估面部轮廓、下颌线条在光影阴影中的骨相表现力。",
...
export const SCREEN_TEST_DUEL: ScreenTestDuel = {
  title: "伯班克 35mm 胶片全装决选试镜（May 2019）",
  date: "2019 年 5 月底",
  location: "华纳兄弟加州伯班克片场（Warner Bros. Studios, Burbank, CA）",
  summary:
    "在敲定帕丁森之前，华纳兄弟制片厂进行了罕见的高规格实拍测试。帕丁森与霍尔特分别飞赴现场，在导演马特·里夫斯与摄影指导格雷格·弗雷泽注视下穿上方·基默的经典战衣，进行 35mm 胶片带妆试镜，并接受近景特写下颌线与眼神戏考量。",
  candidates: [
    {
      ...
      outcome: "全票通过：2019 年 5 月 31 日正式宣布签约当选，成为影史最年轻的独立蝙蝠侠主演之一。",
      laterDcuFate: "主演《新蝙蝠侠》全系列长片三部曲及衍生犯罪宇宙。",
    },
    {
      name: "尼古拉斯·霍尔特（Nicholas Hoult）",
      suitWorn: "历代蝙蝠侠战衣试装测试",
      strengths: "英伦实力派小生代表，戏路跨度极广（《疯狂的麦克斯4》《真宠》），身材修长匀称，具备出色的高压台词功底与贵族气质，试镜评分极高。",
      outcome: "遗憾惜败：与角色擦肩而过，但试镜给华纳高层留下了深刻印象。",
      laterDcuFate: "2023 年被詹姆斯·古恩钦点，加盟新 DCU 宇宙在《超人》（2025）中饰演宿敌莱克斯·卢瑟（Lex Luthor）。",
    },
  ],
  details: [
    "试镜穿的老款橡胶蝙蝠衣没有改良散热系统，单次穿脱需要 5 位服装助理协作耗时近 40 分钟，两位演员在摄影棚高温射灯下均经历了极大的体能消耗。",
    "试镜评估重点并非动作招式，而是‘当戴上面具、只露出口鼻与下颌时，演员能否仅靠眼神和呼吸压迫感完全统治画面’。",
    "马特·里夫斯在剪辑室对比了两人在 35mm 胶片上的特写胶卷后，最终认定帕丁森那种‘如涅槃乐队柯本般的自我放逐与苍凉宿命感’正是新黑色版年轻布鲁斯·韦恩的灵魂所在。",
  ],
};
