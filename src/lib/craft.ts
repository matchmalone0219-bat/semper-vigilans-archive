...
export const THEMES: ThemeCue[] = [
  ...
  },
  {
    ...
    lede: "融合了 1970 年代经典黑色电影的慢板爵士弦乐风格，优雅、神秘且略带伤感，契合猫女瑟琳娜·凯尔复杂多面的游侠特质。",
    sections: [
      {
        heading: "创作灵感与风格定位",
...
export const LENS = {
  ...
  fraser: [
    ...
    {
      heading: "StageCraft LED 虚拟拍摄突破",
      body: "在 2020 年因新冠疫情拍摄受阻后，弗雷泽与里夫斯在英国华纳利维斯登制片厂开创性引入了原本用于《曼达洛人》的 StageCraft LED 环形虚拟天幕（The Volume）。未完工摩天楼的高空阳台、市政厅天台雨夜及警局顶层等关键场景均在此完成，通过高精度虚幻引擎渲染实时背景，不仅将真实的哥谭天际线光影与雨丝高光完美打在演员与战衣上，更彻底规避了传统绿幕溢色与疫情期间频繁户外转场的交叉感染风险。",
    },
  ] satisfies LensNote[],
  messerschmidt: [
    {
...
export const CITIES: LocationCity[] = [
  ...
  },
  {
    ...
    city: "格拉斯哥",
    cityEn: "Glasgow",
    note: "苏格兰最大城市格拉斯哥以维多利亚红砂岩建筑与工业桥梁闻名，是《新蝙蝠侠2》冬季哥谭与战车追逐戏的核心外景舞台。",
    pins: [
      {
        id: "necropolis",
        name: "格拉斯哥墓园",
        ...
        visit: "毗邻格拉斯哥大教堂，全天免费向公众开放步道，可在此俯瞰城市远景并考据片尾分道扬镳的外景视角。",
      },
      {
        id: "glasgow-bridge",
        name: "格拉斯哥大桥",
