...
export const LENS = {
  ...
  stills: [
    ...
    { src: "/media/p2-snow1.jpg", caption: "格拉斯哥公开片场：人造雪所呈现的冬季视觉线索" },
  ],
  fraser: [
    {
  ...
  messerschmidt: [
    {
      heading: "奥斯卡得主接棒掌镜续作",
      body: "埃里克·梅塞施密特曾凭借《曼克》获得奥斯卡最佳摄影奖，并参与《心灵猎人》《杀手》等作品。其既往风格可作为观察背景，但不能替代对续集正式影像的判断。",
    },
    {
      heading: "冬日风雪下的全新光影挑战",
      body: "2026 年 8 月格拉斯哥公开片场可见人造积雪、雾气和大型照明设备。这些只能说明现场条件与冬季视觉方向，最终用光、调色和镜头语言仍需等待正式物料或成片。",
    },
  ] satisfies LensNote[],
};
...
export const CITIES: LocationCity[] = [
    ...
    pins: [
      {
        ...
        body: "圣乔治大厅东立面在第一部中作为市长唐·米切尔追悼会外景。2026 年 5 月，当地媒体记录到制作车辆与灯光设备在周边出现，但未确认这里最终对应续集中的哪一场戏。",
      ...
      },
      {
        ...
        filmAs: "《新蝙蝠侠2》摄制活动报道地点",
        work: "电影《新蝙蝠侠2》",
        image: "/media/p2-trailer.jpg",
        imageAlt: "隧道外景实拍准备中的蝙蝠战车",
        body: "横跨默西河连接利物浦与伯肯黑德的公路隧道。2026 年 5 月，当地报道指摄制活动在隧道内进行；拍摄规模、动作内容和成片用途未获片方说明。",
  ...
  },
  {
    ...
    city: "格拉斯哥",
    cityEn: "Glasgow",
    note: "苏格兰最大城市格拉斯哥以维多利亚红砂岩建筑与工业桥梁闻名，是《新蝙蝠侠2》已确认的冬季外景拍摄城市之一。",
    pins: [
      {
        id: "necropolis",
        name: "格拉斯哥墓园",
      ...
      },
      {
        ...
        body: "横跨克莱德河（River Clyde）连接南北两岸的核心桥梁。2026 年 8 月的道路限制与公开片场画面显示这里出现人造雪、哥谭路标和车辆拍摄；具体动作场面尚未正式披露。",
