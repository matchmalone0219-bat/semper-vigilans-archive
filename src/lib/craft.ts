...
export const LENS = {
  ...
  messerschmidt: [
    ...
    },
    {
      ...
      body: "格拉斯哥片场铺设了大量厚重积雪，并动用重型雾化机、探照灯矩阵与湿滑地面反光。梅塞施密特将延续前作的高反差硬朗光影，同时让皑皑白雪、阴郁乌云与刺目的红蓝警灯产生激烈碰撞，将新哥谭打造成一座表面冰封苍白、地底暗火燃烧的绝美犯罪迷宫！",
    },
  ] satisfies LensNote[],
};
...
export const CITIES: LocationCity[] = [
  {
    ...
    pins: [
      ...
      },
      {
        ...
        body: "横跨默西河连接利物浦与伯肯黑德的著名公路隧道。摄制组深入隧道内部拍摄，结合蝙蝠战车的极速动态，这里极有可能上演一场冬夜狂飙、高速封路对决或战车从闹市区强行潜入地下暗网的硬核动作大戏！",
  ...
  },
  {
    ...
    pins: [
      ...
      },
      {
        ...
        body: "横跨克莱德河（River Clyde）的标志性桥梁全面变身冬日哥谭交通大动脉。在漫天飞雪与警车重重封锁下，这里将成为追逐大戏的核心高潮节点：蝙蝠战车将在大桥飞跃强行突破警方围堵！",
