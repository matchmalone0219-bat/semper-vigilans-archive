...
export const LENS = {
  ...
  messerschmidt: [
    ...
    },
    {
      ...
      body: "格拉斯哥片场铺设了大量人造积雪，并动用雾气设备、探照灯矩阵与湿地反光。本站推测梅塞施密特会保留前作的冷峻反差，同时让白雪、阴云和红蓝警灯彼此碰撞，把哥谭拍成一座表面苍白、内部仍在燃烧的犯罪迷宫。",
    },
  ] satisfies LensNote[],
};
...
export const CITIES: LocationCity[] = [
  {
    ...
    pins: [
      ...
      },
      {
        ...
        body: "横跨默西河连接利物浦与伯肯黑德的著名公路隧道。摄制活动深入隧道内部，而蝙蝠战车同期进入雪地测试；本站推测这里可能承担冬夜极速追逐、封路围捕或战车从市中心切入地下交通网的动作段落。",
  ...
  },
  {
    ...
    pins: [
      ...
      },
      {
        ...
        body: "横跨克莱德河（River Clyde）的核心桥梁被铺成冬日哥谭主干道。结合战车、警车与跨街区封锁调度，本站推测这里会成为追逐路线的重要节点：蝙蝠战车可能在桥面遭拦截，并强行突破警队封锁。",
