...
export const LENS = {
  ...
  messerschmidt: [
    ...
    },
    {
      ...
      body: "2026 年 9 月 19 日蝙蝠侠日，有人问第一部的 film-out 流程（数字拍摄后再转胶片输出）是否回归。里夫斯先回复「Indeed.」，随后解释：数字拍摄的精度与可控性不可替代，「你确切知道自己得到的是什么」；再经 film-out 与镜头选择，把更有机、模拟的质感补回画面，「一种美丽的、被精心发展出来的不完美」。",
    },
    {
