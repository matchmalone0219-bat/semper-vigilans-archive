...
export const PLOT: {
  ...
  {
    tag: "hint",
    text: "8 月 30 日高清战衣路透：特技替身瑞克·英格利希身着续集战衣走在格拉斯哥街头，头套并未戴上，而是挂在斗篷后方。正脸、护颈与胸甲清晰；耳廓加长改款无法从本批照片确认，仍以导演此前公开表态为准。",
...
export const LOG: LogEntry[] = [
  ...
  },
  {
    date: "2026.08.30",
    iso: "2026-08-30",
    title: "替身高清战衣路透：头套未戴，挂在斗篷后方",
    body: "特技替身瑞克·英格利希（Rick English）的高清战衣路透与 4K 视频流出。他身着续集战衣走在格拉斯哥街头，但头套并未戴上，而是挂在斗篷后方；正脸、护颈与胸甲蝙蝠标清晰可见。就目前照片无法从正面确认耳廓加长改款，该改动仍以导演马特·里夫斯此前公开表态为准。此人仍为替身，并非帕丁森本人。",
    kind: "shoot",
