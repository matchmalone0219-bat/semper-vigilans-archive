    ...
    stills: [
      {
        ...
        title: "蝙蝠侠日官方静帧",
        caption:
          "马特·里夫斯 2026 年 9 月 19 日从伦敦发出：蝙蝠侠背对镜头立于落雪与橙月之间。导演未标明这是成片截帧还是摄影测试。",
      ...
      },
      {
        ...
        caption:
          "9 月 20 日伦敦夜戏高清特写：哥谭警局警用巡逻摩托，车尾悬挂「CITY OF GOTHAM / GC-201」牌照，侧边箱附编号 201，与此前格拉斯哥雪景追逐戏实车完全一致。",
        source: "片场路透 · UnBoxPHD",
      },
      {
        src: "/media/log/p2-20-gcpd-201b.jpg",
        title: "GCPD 摩托车尾近景",
        caption:
          "伦敦夜戏现场竖幅近景：清晰展现警用摩托后轮挡泥板、双侧战术边箱与车尾警灯布局。",
        source: "片场路透 · UnBoxPHD",
      },
      {
        ...
        title: "多机位特技跟拍车",
        caption:
          "同场夜戏中停靠的重型黑色越野车，车顶与车侧加装多机位减震支架、低角度云台与监视屏，用于近距离捕捉贴地高速追逐动作（系摄制组摄影器材，非角色专属座驾）。",
        source: "片场路透 · UnBoxPHD",
      },
      {
      ...
      },
      {
        ...
        title: "金斯顿桥下受损战车道具",
        caption:
          "8 月 31 日外景道具细节：车顶与车身结构严重挤压受损，挡风玻璃碎裂。背景立有 KEEP GOTHAM GREEN 市政告示牌与 AWAKE 街头涂鸦。",
        source: "片场路透 · Fraser Wilson",
      },
      {
        src: "/media/log/p2-31-rig1.jpg",
        title: "加装翻滚架的特技战车",
        caption: "特技拍摄配置：战车外挂钢缆翻滚框架，同场备有特制滑橇套件，用于实拍翻覆与路面滑移特技。",
      ...
      },
      {
        ...
        title: "阿尔弗雷德雪地抢救布鲁斯",
        caption:
          "8 月 28 日格拉斯哥大桥日戏：安迪·瑟金斯跪在雪地中，紧急为倒地昏迷的布鲁斯做心肺复苏。一旁有金发女性怀抱男孩凝视，另一条拍摄中布鲁斯双手疑似被手铐锁住。",
        source: "片场路透 · 格拉斯哥大桥",
      },
      {
      ...
      },
      {
        ...
        title: "续集战衣夜戏实拍",
        caption:
          "特技替身瑞克·英格利希（Rick English）身着全套蝙蝠战衣现身格拉斯哥夜戏现场，展现出续集战衣清晰的护甲细节与实材质感。",
      ...
      },
      {
        ...
        title: "特警装甲车列阵围捕",
        caption: "哥谭特警（SWAT）重型装甲车与多辆巡逻警车将蝙蝠战车围在积雪街道中央。",
        source: "片场路透 · ross_sneddon",
      },
      {
        src: "/media/log/p2-24-swat4.jpg",
        title: "战车前脸与装甲车对峙",
        caption: "近距离记录战车全钢冲撞前杠、防滑雪地胎，以及右侧待命的特警装甲车。",
        source: "片场路透 · ross_sneddon",
      },
      {
      ...
      },
      {
        ...
        title: "加装防撞杠的原地漂移",
        caption: "车头加装了拍摄专用的冲撞防护杠，战车在积雪路面上完成原地定圆漂移，用于拍摄复杂的追车与围捕镜头。",
        source: "片场路透 · kt_perspective",
      },
      {
