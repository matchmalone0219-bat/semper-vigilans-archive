...
export const GALLERIES: GalleryGroup[] = [
  ...
  },
  {
    ...
    intro:
      "《新蝙蝠侠2》格拉斯哥外景片场记录。汇总冬季雪景实拍、蝙蝠战车调度、特警围捕、战车撞击突围、阿尔弗雷德复苏戏、战衣细节与副驾神秘乘客等现场线索。",
    stills: [
      {
        src: "/media/log/p2-28-cpr.jpg",
        title: "阿尔弗雷德复苏倒地的布鲁斯",
        caption:
          "格拉斯哥大桥日戏：安迪·瑟金斯跪在雪地上为倒地的布鲁斯做心肺复苏。一旁金发女性怀抱男孩观看，第二次拍摄中布鲁斯双手似被铐住。",
        source: "片场路透 · 格拉斯哥大桥",
      },
      {
        src: "/media/log/p2-28-boat1.jpg",
        title: "克莱德河上的游艇",
        caption: "大桥现场河面停有游艇，悬挂旗帜。外界猜测或与新加盟角色有关，官方尚未说明。",
