...
export const GALLERIES: GalleryGroup[] = [
  ...
  },
  {
    ...
    intro:
      "《新蝙蝠侠2》格拉斯哥片场记录。以下说明会结合连续照片、车辆站位与现场视频进行影迷式场景推演：冬季哥谭、战车追逐、警队围捕与交火猜想，都属于看片场线索的乐趣，并非官方剧情简介。",
    stills: [
      {
        src: "/media/log/p2-escape-1.jpg",
        title: "战车雪地漂移",
        caption:
          "蝙蝠战车在格拉斯哥雪地完成高速漂移，哥谭警车紧随其后；连续画面很像围堵交火前的追逐段落。",
        source: "片场照片 · 当地路透报道",
      },
      {
        src: "/media/log/p2-escape-2.jpg",
        title: "警车列队包围",
        caption: "哥谭市警局（GCPD）涂装车辆在湿滑雪地上形成封锁线，将蝙蝠战车压入狭窄街区。",
        source: "片场照片 · 当地路透报道",
      },
      {
        src: "/media/log/p2-escape-3.jpg",
        title: "雪地高速突围",
        caption: "战衣替身驾驶蝙蝠战车从警车阵列中突围，连续弯道与追拍机位预示一段高强度城市追车。",
        source: "片场照片 · 当地路透报道",
      },
      {
        src: "/media/log/p2-bothwell-snow.jpg",
        title: "博思韦尔街雪景",
        caption: "格拉斯哥博思韦尔街（Bothwell Street）人工铺设厚重雪景，路边停靠哥谭市警车。",
      ...
      },
      {
        ...
        title: "哥谭消防与警用车辆",
        caption: "美式消防车与哥谭警局巡逻车在封街路段整齐陈列，配合大场面调度。",
        source: "片场照片 · 当地路透报道",
      },
      {
      ...
      },
      {
        ...
        title: "外挂摄影支架的战车",
        caption:
          "车尾加装了特制拍摄支架，用于在高速行驶与雪地漂移时捕捉第一视角特写。",
        source: "片场照片 · 当地路透报道",
      },
      {
        ...
        title: "雪景俯瞰机位",
        caption:
          "从高处俯拍战车停在积雪街道上，摄制团队正在调整灯光与降雪布景。",
        source: "片场照片 · 当地路透报道",
      },
      {
        ...
        title: "日间实拍战车",
        caption:
          "日间停靠在街头的蝙蝠战车实车，车身清晰可见雪地防滑轮胎与实战撞击痕迹。",
        source: "片场照片 · 当地路透报道",
      },
      {
      ...
      },
      {
        ...
        title: "战车运抵市区",
        caption:
          "剧组使用平板运输车将蝙蝠战车实车运抵格拉斯哥外景地，已提前换装雪地轮胎。",
        source: "片场照片 · 苏格兰太阳报",
      },
      {
