...
export const GALLERIES: GalleryGroup[] = [
  ...
  },
  {
    ...
    intro:
      "《新蝙蝠侠2》外景实拍画廊。完整记录苏格兰格拉斯哥的冬日雪景追逐、改装战车与升级版战衣细节，以及 9 月中旬剧组移师伦敦圣保罗大教堂拍摄的哥谭法院外群众示威大戏（罗伯特·帕丁森以考究西装造型现身，戈登同场调度；抗议标语引发对猫头鹰法庭与无政府客的推测）。并同步收录博思韦尔街警方秘密押送人员的日戏补档。2026 年蝙蝠侠日，导演马特·里夫斯从伦敦发出一张加框的官方蝙蝠侠静帧。",
    stills: [
      {
