...
export const GALLERIES: GalleryGroup[] = [
  ...
  },
  {
    ...
    intro:
      "《新蝙蝠侠2》拍摄阶段片场记录。以下照片展示格拉斯哥外景中的冬季布景、战车和哥谭警用车辆；画面不能单独证明最终剧情或镜头顺序。",
    stills: [
      {
        src: "/media/log/p2-escape-1.jpg",
        title: "战车雪地漂移",
        caption:
          "格拉斯哥片场的蝙蝠战车雪地车辆特技；哥谭警车也在同一拍摄区域出现。",
        source: "片场照片 · 当地路透报道",
      },
      {
        src: "/media/log/p2-escape-2.jpg",
        title: "警车列队调度",
        caption: "哥谭市警局（GCPD）涂装车辆在湿滑雪地上列队，车辆关系与剧情含义未公开。",
        source: "片场照片 · 当地路透报道",
      },
      {
        src: "/media/log/p2-escape-3.jpg",
        title: "雪地车辆特技",
        caption: "战衣替身与蝙蝠战车参与连续弯道车辆拍摄，最终剪辑用途尚不明确。",
        source: "片场照片 · 当地路透报道",
      },
      {
