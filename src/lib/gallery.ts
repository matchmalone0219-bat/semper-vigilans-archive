...
export const GALLERIES: GalleryGroup[] = [
  ...
  },
  {
    ...
    intro:
      "《新蝙蝠侠2》拍摄阶段片场记录。以下为剧组于苏格兰格拉斯哥外景地实拍期间公开报道的照片资料，展示了冬季哥谭实景与战车追逐戏拍摄现场。",
    stills: [
      {
        src: "/media/log/p2-escape-1.jpg",
        title: "战车雪地漂移",
        caption:
          "格拉斯哥片场拍摄的蝙蝠战车雪地漂移特技，现场同时拍摄了哥谭警车的围堵交火戏份。",
        source: "片场照片 · 当地路透报道",
      },
      {
        src: "/media/log/p2-escape-2.jpg",
        title: "警车列队包围",
        caption: "哥谭市警局（GCPD）涂装车辆在湿滑雪地上列队围堵蝙蝠战车。",
        source: "片场照片 · 当地路透报道",
      },
      {
        src: "/media/log/p2-escape-3.jpg",
        title: "雪地高速追逐",
        caption: "特技替身佩戴头套驾驶蝙蝠战车从警车阵列中突围，完成连续弯道追逐拍摄。",
        source: "片场照片 · 当地路透报道",
      },
      {
