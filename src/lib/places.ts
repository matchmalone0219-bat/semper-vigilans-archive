...
export const PLACES: Place[] = [
  ...
  },
  {
    ...
    body: [
      "位于高谭市中心的哥特式摩天大楼。在旧庄园捐出后，布鲁斯常年深居于顶层阁楼公寓中，并在阿尔弗雷德的照料下进行日常训练与案件研究。地下深处则连通着秘密车间。",
  ...
  },
  {
    ...
    body: [
      "高谭治安的核心指挥中枢，但在前作中暴露出系统性腐败问题。吉姆·戈登中尉在此任职，并多次力排众议将蝙蝠侠带入物证室与停尸间协助勘验线索。",
  ...
  },
  {
    ...
    body: [
      "高谭市最著名的高端地下夜总会，表面上是政商名流寻欢作乐的场所，地下隐秘夹层「44 Below」则是法尔科内掌控毒品交易与政客受贿的秘密据点。",
  ...
  },
  {
    ...
    works: "电影《新蝙蝠侠》",
    body: [
      "高谭市大型综合体育馆。在选举日当晚，数千名避难市民与新任市长候选人贝拉·蕾尔聚集于此，遭到谜语人信徒的武装伏击并面临决堤海水灌入的灭顶之灾。",
      "蝙蝠侠在此跳入水中斩断带电电缆、点燃照明弹引导平民撤离，完成了从单纯的「复仇者」向城市守护者的伟大升华。",
    ],
  },
  {
    id: "arkham",
    ...
    works: "漫画《谜语人元年》 · 电影《新蝙蝠侠》 · 限定剧《企鹅人》",
    body: [
      "高谭市关押极度危险精神障碍重犯与连环杀手的特殊医疗机构。谜语人爱德华·纳什顿与神秘重犯（小丑）均关押于此；索菲亚·法尔科内亦曾被不公关押长达十年并在剧终再度被送回。",
      "作为高谭阴暗罪恶的集大成之地，阿卡姆始终是笼罩在整座城市上空的无形阴影。",
    ],
  },
  {
    id: "riddler-room",
  ...
  },
  {
    ...
    works: "限定剧《企鹅人》",
    body: [
      "高谭市贫困边缘社区，受大洪水灾害破坏最为严重。在《企鹅人》剧集中，这里成为奥兹藏匿违禁品、招兵买马并与索菲亚军队展开残酷巷战的主战场，见证了奥兹踩着尸骨登顶的全过程。",
    ],
  },
  {
    id: "city-hall",
    ...
    imageAlt: "高谭市政办公大厅与城市徽标",
    status: "正常运转",
    people: ["bella", "mitchell", "colson"],
    works: "电影《新蝙蝠侠》 · 限定剧《企鹅人》",
    body: [
      "高谭市政治与行政最高中枢。前市长唐·米切尔与前检察官吉尔·科尔森曾在此办公并深涉法尔科内黑金网络；贝拉·蕾尔在第一部后宣誓就任新市长并在此推行灾后重建与反腐改革。",
    ],
  },
];
