...
export const GOTHAM_CITY = {
  ...
  families: [
    ...
    { name: "阿卡姆家族", note: "玛莎母家。约 1721 年创办州立医院，家族病史被买通压下" },
...
export const PLACES: Place[] = [
  ...
  },
  {
    ...
    works: "漫画《谜语人元年》 · 电影《新蝙蝠侠》 · 限定剧《企鹅人》",
    body: [
      "院名来自创办它的阿卡姆家族，不是后来才出现的「疯人院」绰号。设定上约 1721 年即作为收治重症精神病人的州立医院存在，本意面向各阶层，后来变成关押刑事精神犯的高戒备机构。成片刻意叫 State Hospital，不叫 Asylum。",
      "玛莎·阿卡姆在此进出多年，家族买通院方封口；你在人物档里看到的那张被护工架出院墙的照片，就是这段病史的物证。二十年后，同一栋楼关着谜语人、小丑，也曾关过被诬为「绞刑吏」的索菲亚·法尔科内十年。布鲁斯母亲的姓，和关他敌人的那栋楼，是同一个词。",
      "高戒备区有防弹单向玻璃探视间。蝙蝠侠第一年把神秘重犯（小丑）关在这里；谜语人炸坝后进邻近病房，两人隔墙说话。《企鹅人》里索菲亚出狱又被送回。对布鲁斯而言，母亲的姓和关押敌人的那栋楼是同一个词。",
    ],
  },
  {
    id: "riddler-room",
