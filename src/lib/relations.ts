...
export const FACTIONS: {
...
}[] = [
  {
    ...
    x: 100,
    y: 36,
    note: "高谭历史悠久的豪门。旧庄园曾捐建为孤儿院，布鲁斯深居韦恩塔顶层并在此建立地下车间。",
  },
  {
    id: "city",
    label: "市政与警方 (GCPD)",
    x: 520,
    y: 36,
    note: "高谭执法与行政体系，包含新任市长贝拉、正直警官戈登以及第一部中涉案的受贿官员。",
  },
  {
    id: "falcone",
    label: "法尔科内家族",
    x: 100,
    y: 456,
    note: "曾掌控高谭数十年的黑道帝国。卡尔迈恩死后，其家族残余势力与后人仍深远影响城市走向。",
  },
  {
    id: "under",
    label: "地下黑道",
    x: 520,
    y: 456,
    note: "权力洗牌后的黑帮新格局。企鹅人奥兹·科布在剧集中铲除对手，强势登顶高谭黑道新王。",
  },
  {
    id: "arkham",
    label: "阿卡姆疯人院",
    x: 860,
    y: 456,
    note: "关押高谭极度危险重犯的州立医疗机构，谜语人、索菲亚（曾收押）及神秘囚徒均在此停留。",
  },
];
...
export const NODES: RelNode[] = [
  {
    ...
    bio: [
      ...
      "两人在剧院后巷遇刺身亡，成为布鲁斯走上义警道路的起点，也让高谭陷入长达数十年的权力失序。",
    ],
  },
  {
    id: "bruce",
    ...
    bio: [
      ...
      "罗伯特·帕丁森已确认在续集中回归，故事将在冬日展开，深入展现面具之下的人性挣扎。",
    ],
  },
  {
    id: "alfred",
    ...
    actor: "安迪·瑟金斯",
    bio: [
      "布鲁斯最信任的导师与后方管家，前英国情报人员。他不仅传授布鲁斯侦查技能与格斗战术，更是布鲁斯唯一的精神支柱。在第一部炸弹袭击中幸存，已确认在续集中回归。",
    ],
  },
  {
    id: "bella",
    ...
    actor: "洁米·劳森",
    bio: [
      "年轻有为的政治家，主张公开透明与战后反腐改革。在竞选集会枪击与决堤洪灾中沉着应对并当选市长，主导城市灾后重建，已确认在续集中回归。",
    ],
  },
  {
    id: "gordon",
    ...
    actor: "杰弗里·怀特",
    bio: [
      "高谭警局中难能可贵的正直警官，力排众议与蝙蝠侠并肩破获连环大案，并在局顶亲自点亮蝙蝠信号灯，已确认在续集中回归。",
    ],
  },
  {
    id: "martinez",
  ...
  },
  {
    ...
    actor: "鲁伯特·彭利-琼斯",
    bio: [
      "前任高谭市长，万圣节首位遇害者。其官邸遇害后流出的密照直接牵扯出冰山俱乐部与权贵洗钱黑幕。",
    ],
  },
  {
    id: "colson",
    ...
    actor: "彼得·萨斯加德",
    bio: [
      "前任高谭地方检察官，深度卷入法尔科内黑金网络。在市长葬礼上被项圈炸弹劫持，因拒绝供出告密者被当众引爆身亡。",
    ],
  },
  {
    id: "carmine",
    ...
    actor: "约翰·特托罗",
    bio: [
      "曾统治高谭数十年的黑帮教父。在第一部结尾被揭露为向警方出卖马罗尼的秘密线人（“老鼠”），走出俱乐部时遭谜语人狙杀。",
    ],
  },
  {
    id: "selina",
    ...
    actor: "佐伊·克拉维茨",
    bio: [
      "法尔科内的私生女。身手敏捷的神偷与独行侠，曾协助蝙蝠侠办案。解决恩怨后离开高谭前往布鲁德海文（Blüdhaven）。",
    ],
  },
  {
    id: "annika",
  ...
  },
  {
    ...
    actor: "科林·法瑞尔",
    bio: [
      "原法尔科内手下得力干将。在限定剧《企鹅人》中凭借阴谋扫清对手登顶高谭地下新王，已确认在续集中强势回归。",
    ],
  },
  {
    id: "victor",
  ...
  },
  {
    ...
    actor: "保罗·达诺",
    bio: [
      "前司法会计师，策划了针对高谭权贵的连环暗杀与炸毁防洪大堤惨剧。现羁押于阿卡姆疯人院高戒备病房。",
    ],
  },
  {
    id: "joker",
...
export const PORTRAITS: Record<string, { src: string; note?: string }> = {
  ...
  bruce: { src: "/media/portraits/bruce.jpg" },
  alfred: { src: "/media/portraits/alfred.jpg" },
  bella: { src: "/media/portraits/bella.jpg" },
  gordon: { src: "/media/portraits/gordon.jpg" },
  martinez: { src: "/media/portraits/martinez.jpg" },
  colson: { src: "/media/still-mud.jpg", note: "彼得·萨斯加德 饰 吉尔·科尔森" },
  mitchell: { src: "/media/craft/two-temple.jpg", note: "鲁伯特·彭利-琼斯 饰 唐·米切尔市长" },
  annika: { src: "/media/still-selina-apt.jpg", note: "安妮卡·科索洛夫" },
  carmine: { src: "/media/portraits/carmine.jpg" },
  selina: { src: "/media/portraits/selina.jpg" },
  sofia: { src: "/media/portraits/sofia.jpg" },
  oz: { src: "/media/portraits/oz.jpg" },
  victor: { src: "/media/portraits/victor.jpg" },
  edward: { src: "/media/portraits/edward.jpg" },
  joker: { src: "/media/portraits/joker.jpg" },
};
