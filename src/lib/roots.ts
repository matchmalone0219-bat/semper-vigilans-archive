...
export const CINEMA_ROOTS: CinemaWork[] = [
  ...
  },
  {
    ...
    lede: "大卫·芬奇的《七宗罪》为本片的连环暗杀结构与视觉基调提供了直接参照。保罗·达诺饰演的谜语人与凯文·史派西饰演的约翰·多伊（John Doe）在作案哲学与终局设计上具有高度互文性。里夫斯另将真实的黄道十二宫杀手（Zodiac Killer）称为谜语人的「现实世界类比」——暗号、自制头套与向媒体投递，让现实犯罪史的阴影进一步叠入这套杀手美学。",
