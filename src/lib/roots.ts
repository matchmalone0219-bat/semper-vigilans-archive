...
export const ROOTS: RootWork[] = [
  ...
  },
  {
    ...
    thesis: "帕丁森跳出传统战术实用主义解释的关键参考：蝙蝠不仅是威吓罪恶的披风，更是布鲁斯坚信自己与之合二为一的超现实图腾。",
    lede: "故事设定于义警生涯最初数周，时间线紧密咬合《元年》前夕。布鲁斯未披上斗篷前在阿拉斯加雪原重伤垂死，原住民萨满佩戴仪式蝙蝠面具、以图腾传说将其救愈，并嘱其誓守秘密。帕丁森汲取了其中的原始图腾体验，而非后半段邪教凶杀的猎奇情节。",
    sources: [
      {
        label: "Entertainment Weekly",
        note: "2022 年 2 月 18 日，帕丁森在专访中对照诺兰电影对战衣的战术实用解释，强调《萨满》中超现实的图腾感。",
      },
    ],
    parallels: [
      {
        comic: "萨满口述的蝙蝠传说并非战术指南，而是让濒死者相信自己的生命已与这只夜行生物融为一体。",
        film: "帕丁森由此确立表演支点：穿上战衣后，布鲁斯从心底深信图腾赋予了自己超常力量，哪怕物理层面他依然只是一介凡人。",
      },
      {
        comic: "阿拉斯加的萨满面具最终被永久留存蝙蝠洞，时刻警醒布鲁斯面具之下已被转化的自我。",
        film: "开场在命案现场俯身勘验时，帕丁森追求的是幽灵与德鲁伊般的神秘仪式姿态，而非重装坦克般的机械战甲。",
      },
    ],
    sections: [
      {
        heading: "阿拉斯加的面具与誓言",
        body: "布鲁斯早年在雪山荒野跟随赏金猎人威利·多格特追踪逃犯，遭遇伏击导致多格特身亡，自己亦倒卧暴风雪中垂死。原住民萨满与其女儿将其救回部落，并以蝙蝠图腾古歌为其唤魂疗伤。布鲁斯返城后无意中将秘传传说泄露给韦恩资助的研究学者，间接引发哥谭连环邪教命案。在破获阴谋后，萨满面具被布鲁斯带回蝙蝠洞，成为他精神溯源的隐秘见证。",
      },
      {
        heading: "帕丁森取走的部分",
        body: "里夫斯并未直接将阿拉斯加外景或邪教犯罪搬上银幕，但帕丁森敏锐地抓取了这部冷门篇章的心理内核：穿戴蝙蝠装束并非出于精打细算的战术伪装，而更接近原始巫医对图腾服饰赋予超自然力量的狂热笃信。在他沉浸式的演绎下，这套战衣不再是冰冷的外接防弹装备，而是直接长在血肉之上的第二层皮肤。",
      },
    ],
  },
  {
    ...
    imageAlt: "《Secret Origins of the World's Greatest Super-Heroes》封面，布赖恩·博兰（Brian Bolland）绘",
    thesis: "同篇访谈提及的轻量起源对照：坠入深井、周游学艺与破窗撞入的蝙蝠在十六页中一气呵成；里夫斯跳过了这些耳熟能详的开端。",
    lede: "这是 1989 年起源选集中唯一的全新原创短篇。丹尼斯·奥尼尔将幼年跌落溶洞、双亲遇害、青年出洋学艺以及破窗蝙蝠撞入书房等经典片段熔铸为 16 页的宿命诗篇。诺兰曾在《侠影之谜》中深度借用该篇；而里夫斯与帕丁森则选择直接切入义警生涯第二年，将起源沉淀为角色的心理潜意识。",
    sources: [
      {
        label: "Entertainment Weekly",
    ...
    parallels: [
      {
        comic: "夜蝠撞碎书房玻璃窗的瞬间，布鲁斯立下誓言；旁白宿命般地写道：他的一生将永远处于无止境的坠落之中。",
        film: "成片省略了落洞与撞窗的具体场景；帕丁森以此篇作为角色心理注脚：布鲁斯成为黑暗义警更像是一场深陷其中、无法醒来的噩梦。",
      },
    ],
    sections: [
      {
        heading: "对照，不是蓝本",
        body: "奥尼尔用十六页篇幅梳理了经典起源的全部关键意象——深井坠落、剧场丧亲、环球学艺与撞窗蝙蝠。与诺兰在《侠影之谜》中将其作为主要改编骨架不同，里夫斯宇宙完全避开了这些已在银幕上反复呈现的经典镜头。帕丁森提及此篇，意在表明里夫斯宇宙的蝙蝠侠无须再次展示坠落的动作，因为他从登场的第一秒起，就已经身处坠落的深渊之中。",
      },
    ],
  },
];
