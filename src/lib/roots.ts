...
export const RIDDLE_LORE: RiddleLoreItem[] = [
  ...
  {
    id: "colson-joke",
    kicker: "05 / 地方检察官项圈炸弹第二问",
    kickerEn: "05 / DA Colson Collar Bomb · Riddle 2",
    title: "致命玩笑：动词固定搭配背后的体制讽刺",
    titleEn: "A Joke: Verbal Collocations & Institutional Farce",
    prompt: "I can be tapped, I can be cracked, I can be given, I can be told, I can be made... What am I?",
    promptEn: "I can be tapped, I can be cracked, I can be given, I can be told, I can be made... What am I?",
    answer: "A JOKE.（笑话）",
    answerEn: "A JOKE.",
    targetScene: "教堂大厅倒计时持续跳动，蝙蝠侠在电话旁迅速推理出动词规律替科尔森作答。",
    targetSceneEn: "Cathedral ticking clock: Batman deduces the grammatical pattern on speakerphone.",
    literalMeaning: "供人娱乐、引人发笑的诙谐言语或滑稽短剧。",
    literalMeaningEn: "A humorous anecdote or remark meant to provoke laughter.",
    linguisticTrap: "完全由英语中与‘Joke’搭配的地道动词短语组成的一串排比句：Crack a joke（讲笑话/破功笑出声）、Tell a joke（讲笑话）、Make a joke（开玩笑）、Give a joke（讲冷笑话）、Tap a joke（顺应调侃）。直译为中文时动词意义分散，难以直接联想出核心名词。",
    linguisticTrapEn: "A sequence composed strictly of natural English verb-noun collocations with 'joke': crack a joke, tell a joke, make a joke, give a joke. When translated literally, the coherence vanishes.",
    narrativeTruth: "不仅是动词语法游戏，更是全片深层主旨的黑色映射：在谜语人眼里，哥谭市的法治、警察誓词、市长选举乃至所谓‘打击犯罪’，全是一场被黑手党幕后操控的彻头彻尾的滑稽笑话。同时也是对阿卡姆隔壁即将登场的‘小丑（Joker）’的遥远回响。",
    narrativeTruthEn: "Transmutes grammatical play into dark indictment: in Nashton's eyes, Gotham's legal oaths, elections, and mayoral cleanups are all a morbid joke run by gangsters—foreshadowing the Joker in Arkham.",
    image: "/media/still-colson.jpg",
    imageAlt: "项圈炸弹受害者地方检察官科尔森在追悼会现场",
    imageAltEn: "DA Gil Colson trembling in the cathedral under the collar bomb threat",
    imageCaption: "现场剧照：科尔森在直播镜头前冷汗直流，面对哥谭司法沦为笑话的公开处决",
    imageCaptionEn: "Film still: Colson sweating under the live broadcast, realizing his entire career was a corrupt joke",
    kind: "scene",
  },
  {
    id: "bruce-manor",
    kicker: "06 / 针对韦恩家族的信件",
    kickerEn: "06 / Letter to the Wayne Legacy",
  ...
  },
  {
    ...
    kicker: "07 / 阿卡姆病房终极交锋",
    kickerEn: "07 / Arkham Hospital Interrogation",
  ...
  },
  {
    id: "joker-friend",
    kicker: "08 / 阿卡姆隔壁尾声彩蛋",
    kickerEn: "08 / Arkham Adjoining Cell Epilogue",
