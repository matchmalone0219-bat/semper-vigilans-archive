...
export const ROOTS_INTRO =
  "马特·里夫斯执导的《新蝙蝠侠》并非对单一漫画篇目的机械改编，而是融合了 DC 漫画史上数部标杆作品的精神内核与 1970 年代新好莱坞犯罪经典的光影基因：布鲁斯·韦恩的自我审判汲取自达温·库克的《蝙蝠侠：自我》；写实侦探风貌源自弗兰克·米勒的《蝙蝠侠：元年》；黑帮统治与节庆连环谜案承袭自《漫长的万圣节》；终局大堤决口则与《零年》形成互文；而在电影语言上，影片深刻致敬了《唐人街》《出租车司机》《总统班底》《七宗罪》与《法国贩毒网》等影史传世之作。";
...
export const CINEMA_ROOTS: CinemaWork[] = [
  {
    ...
    lede: "马特·里夫斯多次公开将《唐人街》奉为第一部剧本创作的最核心灵感。从高谭防洪大坝暗藏的黑幕，到侦探被上层阶级肆意玩弄的无力感，两部作品在结构与主旨上高度契合。",
    parallels: [
      {
        cinema: "私家侦探杰克·吉蒂斯（Jack Gittes）顺着一起看似普通的通奸案，层层揭开洛杉矶水务局侵吞公共资源的惊天阴谋。",
        batman: "蝙蝠侠从市长唐·米切尔的私情密照入手，逐步撕开法尔科内掌控百亿「新生」基金与高谭水利大坝的腐败巨网。",
      },
      {
    ...
    parallels: [
      {
        ...
        batman: "布鲁斯在地下车间借着昏暗台灯书写《高谭项目》夜巡日记，画外音冷酷宣称‘雨夜中的城市在自我吞噬’。",
      },
      {
        cinema: "特拉维斯眼中的城市充斥着霓虹光晕、潮湿路面与道德沦丧，最终促使其走上极端暴力‘清洗’之路。",
        batman: "格雷格·弗雷泽运用钠黄街灯、失焦虚化与浅景深镜头，将高谭塑造成一座布满泥泞与阴郁窒息感的异化深渊。",
      },
    ],
    breakdown: [
      {
    ...
    parallels: [
      {
        ...
        batman: "谜语人按高谭受贿权贵名单依次处决市长、局长与检察官，并在现场留下定制问号贺卡与血字封条。",
      },
      {
