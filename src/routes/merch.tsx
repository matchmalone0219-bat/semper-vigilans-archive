    ...
    <main>
      <header className="relative isolate overflow-hidden border-b border-fg/10">
        ...
        <p className="mt-4 max-w-2xl text-pretty leading-relaxed text-muted">
          收录《新蝙蝠侠》上映期间及之后推出的官方授权衍生品，涵盖收藏级人偶与道具、雕像、载具、乐高、院线特典、授权印刷、时装首饰、生活方式联名，以及大众玩具与服装。只收 Reeves 版电影授权，不拿泛蝙蝠侠产品充数。第二部电影周边尚未公布。
        </p>
      ...
      <p className="mx-auto max-w-6xl px-4 pb-16 text-sm text-faint sm:px-6">
        ...
        LANVIN、Carhartt、PUMA、Fossil、Police、Kross Studio、House of Sillage、Dr. Squatch、Rubies、Mondo、Abrams
