...
import { getPerson, relatedPeople } from "@/lib/people";
          ...
          <section>
            ...
            <ul className="mt-6 divide-y divide-fg/10 border-y border-fg/10">
              {person.appearances.map((a) => (
                <li key={a.work} className="flex flex-col gap-1 py-4 sm:flex-row sm:items-baseline sm:gap-8">
                  <Link
                    to={a.href}
                    hash={a.hash}
                    ...
                    >
                      <span className="flex items-center gap-3">
                        ...
                        <span>
                          ...
                          <span className="ml-2 text-sm text-faint">{STATUS_LABEL[other.status]}</span>
                        </span>
                      </span>
                      <span
                        className={cn(
